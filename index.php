...
if (isset($typeString)) {
	...
	// */
	// Do the conversion
	// $command = "java -jar ". BATIK_PATH ." -scriptSecurityOff $typeString -d $outfile $width temp/$tempName.svg 2>&1";
	// $output = shell_exec($command);
	// echo "Command: $command <br>";
	// echo "Output: $output";
	// die;

	$output = shell_exec("java -jar ". BATIK_PATH ." -scriptSecurityOff $typeString -d $outfile $width temp/$tempName.svg");
